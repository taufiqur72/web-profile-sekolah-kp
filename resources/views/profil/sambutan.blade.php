...
@section('description', 'Sambutan resmi dari Kepala Sekolah TK Al Husainiyah mengenai visi dan misi sekolah dalam mendidik generasi Qur\'ani.')
            ...
            @if($profile->foto_profil)
                <div class="col-12 col-lg-4" data-aos="fade-right">
                    <div class="position-relative overflow-hidden rounded-4">
                        <img
    src="{{ Storage::url($profile->foto_profil) }}"
